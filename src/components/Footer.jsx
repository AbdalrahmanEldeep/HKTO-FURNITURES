                            ...
                            <form action="#">
                                <div class=" flex items-center mt-10">
                                    <input type="email" placeholder="yourmail@example.com"
                                        class="flex-1 appearance-none rounded shadow p-3 py-2 text-grey-dark mr-2 focus:outline-none"/>
                                    <button type="submit"
                                        class="bg-primary hover:bg-main text-white text-base font-semibold rounded-md shadow-md  px-5 py-2">Get
                                        started</button>
                                </div>
                            </form>
                        </div>
